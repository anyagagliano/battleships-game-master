...
app.get("/rest/scores", async (req, res) => {
...
app.post("/rest/scores", async (req, res) => {
  console.log("req.body", req.body)
  let query = "INSERT INTO scores SET name = ?, points = ?"
  let result = await db.query(query, [req.body.name, req.body.points])
  res.json(result)
})
